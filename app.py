...
if st.session_state.app_state == "welcome":
    ...
    if settings_sheet:
        ...
        if st.button("Начать"):
            ...
            # УСИЛЕННЫЙ ПРОМПТ ДЛЯ ЭМОДЗИ
            st.session_state.persona = (
                f"Ты {h['Name']}. {h['Prompt']}. Собеседник: {st.session_state.u_name}. "
                "ВАЖНО: Всегда используй подходящие эмодзи в каждом сообщении. Пиши живым языком."
            )
